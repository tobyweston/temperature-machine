...
class IgnoreTemperatureSpikesTest extends Specification {
  ...
  "Delegates" >> {
    ...
    new IgnoreTemperatureSpikes(delegate).write(Measurement(Host("example", None), Seconds(1), List(SensorReading("A", Temperature(21.1)))))
  ...
  "Ignores spiked value (single sensor)" >> {
    ...
    writer.write(Measurement(Host("example", None), Seconds(4), List(SensorReading("A", Temperature(51.1)))))
    delegate.temperatures must_== List(
      Measurement(Host("example", None), Seconds(1), List(SensorReading("A", Temperature(21.1)))),
      ...
      Measurement(Host("example", None), Seconds(4), List(SensorReading("A", Temperature(21.6))))
    )
  }
  ...
  "Ignore spiked values (multiple sensors)" >> {
    ...
    writer.write(Measurement(Host("example", None), Seconds(7), List(SensorReading("A", Temperature(51.6)))))
    ...
    writer.write(Measurement(Host("example", None), Seconds(8), List(SensorReading("B", Temperature(51.1)))))
    delegate.temperatures must_== List(
      Measurement(Host("example", None), Seconds(1), List(SensorReading("A", Temperature(21.1)))),
      Measurement(Host("example", None), Seconds(3), List(SensorReading("A", Temperature(21.6)))),
      Measurement(Host("example", None), Seconds(5), List(SensorReading("A", Temperature(21.1)))),
      Measurement(Host("example", None), Seconds(7), List(SensorReading("A", Temperature(21.1)))),
      ...
      Measurement(Host("example", None), Seconds(8), List(SensorReading("B", Temperature(31.4))))
    )
  }
  ...
  "Recovers from spiked value (single sensor)" >> {
    ...
    writer.write(Measurement(Host("example", None), Seconds(3), List(SensorReading("A", Temperature(21.6)))))
    writer.write(Measurement(Host("example", None), Seconds(4), List(SensorReading("A", Temperature(51.1)))))
    writer.write(Measurement(Host("example", None), Seconds(5), List(SensorReading("A", Temperature(51.2)))))
    writer.write(Measurement(Host("example", None), Seconds(6), List(SensorReading("A", Temperature(51.5)))))
    ...
    delegate.temperatures must_== List(
      ...
      Measurement(Host("example", None), Seconds(3), List(SensorReading("A", Temperature(21.6)))),
      Measurement(Host("example", None), Seconds(4), List(SensorReading("A", Temperature(21.6)))),
      Measurement(Host("example", None), Seconds(5), List(SensorReading("A", Temperature(21.6)))),
      Measurement(Host("example", None), Seconds(6), List(SensorReading("A", Temperature(21.6)))),
  ...
  "Doesn't ignore negative spiked values (single sensor)" >> {
    ...
    writer.write(Measurement(Host("example", None), Seconds(2), List(SensorReading("A", Temperature(21.4)))))
    writer.write(Measurement(Host("example", None), Seconds(3), List(SensorReading("A", Temperature(21.6)))))
    writer.write(Measurement(Host("example", None), Seconds(4), List(SensorReading("A", Temperature(1.1)))))
    delegate.temperatures must_== List(
      Measurement(Host("example", None), Seconds(1), List(SensorReading("A", Temperature(21.1)))),
      Measurement(Host("example", None), Seconds(2), List(SensorReading("A", Temperature(21.4)))),
      Measurement(Host("example", None), Seconds(3), List(SensorReading("A", Temperature(21.6)))),
      Measurement(Host("example", None), Seconds(4), List(SensorReading("A", Temperature(1.1))))
    )
  }
