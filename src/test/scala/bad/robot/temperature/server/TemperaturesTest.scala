...
class TemperaturesTest extends Specification {
  ...
  "Filter out old temperatures" >> {
    val measurement1 = Measurement(Host("lounge", None), Seconds(0), List(
      SensorReading("28-00000dfg34ca", Temperature(31.1)),
      SensorReading("28-00000f33fdc3", Temperature(32.8))
    ))
    val measurement2 = Measurement(Host("bedroom", None), Seconds(120), List(
    ...
    val expected = Map(
      Host("bedroom", None) -> Measurement(Host("bedroom", None), Seconds(120), List(
        SensorReading("28-00000f3554ds", Temperature(21.1)),
        SensorReading("28-000003dd3433", Temperature(22.8))
      ))
    )
  ...
  "Filter out old temperatures when averaging" >> {
    ...
    val measurement2 = Measurement(Host("bedroom", None), Seconds(60), List(
      SensorReading("28-00000f3554ds", Temperature(21.1)),
      SensorReading("28-000003dd3433", Temperature(22.8))
    ))
    ...
    val expected = Map(
      Host("bedroom", None) -> Measurement(Host("bedroom", None), Seconds(60), List(
