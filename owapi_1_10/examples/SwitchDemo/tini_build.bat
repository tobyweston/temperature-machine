...
@echo TINI Convert...
java -classpath %TINI_HOME%\bin\tini.jar;. BuildDependency -p ..\..\lib\owapi_dependencies_TINI.jar -f tini -x ..\..\lib\owapi_dep.txt -o tini\SwitchDemo.tini -add Switches -d %TINI_HOME%\bin\tini.db
