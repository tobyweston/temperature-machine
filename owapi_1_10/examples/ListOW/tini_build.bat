...
@echo TINI Convert...
java -classpath %TINI_HOME%\bin\tini.jar;. BuildDependency -p ..\..\lib\owapi_dependencies_TINI.jar -f tini -x ..\..\lib\owapi_dep.txt -o tini\ListOW.tini -d %TINI_HOME%\bin\tini.db
