...
---------------------------------------------------------
| 1-Wire Temperature Utility (TemperatureContainerDemo) |
---------------------------------------------------------

I. Description
=------------=
Text/menu driven application to read any 1-Wire device 
that implements the TemperatureContainer interface.
...
TemperatureContainerDemo.class       - prebuilt Desktop class
\src\TemperatureContainerDemo.java   - source for this example
\tini\TemperatureContainerDemo.tini  - prebuilt TINI class (for TINI 1.02 or later)
...
1. Use the provided 'run.bat' to start this application.
   It will automatically search for an Temperature device on the 
   Default 1-Wire port. A menu will then be presented with 
   options to read the Thermometer.  
...
1. Load TemperatureContainerDemo from the examples\TemperatureContainerDemo\tini directory
   ...
   of this discussion assume you chose 180.0.42.43 for your IP address):
       ...
       tini
       bin
       put TemperatureContainerDemo.tini
       close
       quit
...
3. To get command line systax execute TemperatureContainerDemo without any parameter
   'java TemperatureContainerDemo.tini'.  Parameters can be added as described above
   under Desktop.
...
4. Use the 'tini_build.bat' to rebuild this example for TINI.  Note that this 
   ...
   'tini_build.bat' compiles in all known types of Thermometers.  The end result 
